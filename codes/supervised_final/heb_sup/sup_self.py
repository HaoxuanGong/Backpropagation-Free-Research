...
from torchvision.transforms import Compose, ToTensor, Normalize, Lambda, RandomHorizontalFlip, RandomRotation
...
def load_MNIST_data(train_batch_size=30000, test_batch_size=10000):
    data_transformation = Compose([
        ToTensor(),
